...
public class UiByeolhoTowerRewardView : MonoBehaviour
{
    [SerializeField]
    ...
    public void UpdateRewardView(int idx)
    {
        ...
        var towerTableData = TableManager.Instance.ByeolhoTower.dataArray[idx];
    ...
    public void OnClickRightButton()
    {
        ...
        currentId = Mathf.Min(currentId, TableManager.Instance.ByeolhoTower.dataArray.Length - 1);
    ...
    public void UpdateButtonState()
    {
        ...
        rightButton.interactable = currentId != TableManager.Instance.ByeolhoTower.dataArray.Length - 1;
    }
}
