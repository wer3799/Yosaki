...
public class UiCommonEventAttend2Pass : FancyScrollView<PassData_Fancy>
{
    ...
    {
        string freeKey = OneYearPassServerTable.commonEvent2Free;
        string adKey = OneYearPassServerTable.commonEvent2Ad;

        List<int> splitData_Free = GetSplitData(OneYearPassServerTable.commonEvent2Free);
        List<int> splitData_Ad = GetSplitData(OneYearPassServerTable.commonEvent2Ad);
        ...
        string free = ServerData.oneYearPassServerTable.TableDatas[OneYearPassServerTable.commonEvent2Free].Value;
        string ad = ServerData.oneYearPassServerTable.TableDatas[OneYearPassServerTable.commonEvent2Ad].Value;
        ...
        if (rewardedNum > 0)
        {
            ServerData.oneYearPassServerTable.TableDatas[OneYearPassServerTable.commonEvent2Free].Value = free;
            ServerData.oneYearPassServerTable.TableDatas[OneYearPassServerTable.commonEvent2Ad].Value = ad;
            ...
            passParam.Add(OneYearPassServerTable.commonEvent2Free, ServerData.oneYearPassServerTable.TableDatas[OneYearPassServerTable.commonEvent2Free].Value);
            passParam.Add(OneYearPassServerTable.commonEvent2Ad, ServerData.oneYearPassServerTable.TableDatas[OneYearPassServerTable.commonEvent2Ad].Value);
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < tableData.Length; i++)
        {
            ...
            passInfo.rewardType_Free_Key = OneYearPassServerTable.commonEvent2Free;

            passInfo.rewardType_IAP = tableData[i].Reward2;
            passInfo.rewardTypeValue_IAP = tableData[i].Reward2_Value;
            passInfo.rewardType_IAP_Key = OneYearPassServerTable.commonEvent2Ad;
