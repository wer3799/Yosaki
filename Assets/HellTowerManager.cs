...
public class HellTowerManager : ContentsManagerBase
{
    ...
    private IEnumerator StartAutoStart()
    {
        ...
        {
            GameManager.Instance.LoadContents((ServerData.userInfoTable.GetTableData(UserInfoTable.currentFloorIdx3).Value >=
                                               TableManager.Instance.towerTable3.dataArray.Length) == false
