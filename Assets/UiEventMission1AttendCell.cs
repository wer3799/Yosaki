...
public class UiEventMission1AttendCell : FancyCell<PassData_Fancy>
{
    ...
    {
        int killCountTotalBok = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.eventMission1AttendCount).Value;
