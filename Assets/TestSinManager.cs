...
public class TestSinManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/TestSin");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.sinsunGodScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.sinsunGodScore].Value = reqValue;

            ServerData.userInfoTable_2.UpData(UserInfoTable_2.sinsunGodScore, false);
        }
