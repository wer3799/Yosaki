...
public class UiSAMinigameHighScoreRewardCell : MonoBehaviour
{
    [SerializeField]
    ...
    private void Subscribe()
    {
        ...
        ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.eventMiniGameScore_TopRate).Subscribe(e =>
        {
    ...
    public void OnClickFreeRewardButton()
    {
        ...
        {
            PopupManager.Instance.ShowAlarmMessage("최고 점수가 부족합니다.");
            return;
        }
    ...
    {
        var score = ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.eventMiniGameScore_TopRate).Value;
