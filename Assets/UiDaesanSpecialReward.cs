...
public class UiDaesanSpecialReward : MonoBehaviour
{
    [SerializeField]
    ...
    public void OnClickExchangeButton()
    {
        ...
        if (double.Parse(ServerData.bossServerTable.TableDatas["b55"].score.Value) < 1e+180)
        {
            PopupManager.Instance.ShowAlarmMessage("피해량이 1채 이상이어야 합니다.");
            return;
        }
