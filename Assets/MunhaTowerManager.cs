...
public class MunhaTowerManager : ContentsManagerBase
{
     [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/MunhaTower");
    ...
    private void SendScore()
    {
        ...
        {
            ServerData.bossScoreTable.UpdateScoreToServer(BossScoreTable.munhaScore,reqValue);
