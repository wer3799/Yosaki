...
public class UiGuimoonPassSystem : MonoBehaviour
{
    [SerializeField]
    private UiGuimoonPassCell uiPassCellPrefab;

    [SerializeField]
    private Transform cellParent;


    private List<UiGuimoonPassCell> uiPassCellContainer = new List<UiGuimoonPassCell>();
    ...
    private void Initialize()
    {
        ...
        {
            var prefab = Instantiate<UiGuimoonPassCell>(uiPassCellPrefab, cellParent);
        ...
        for (int i = 0; i < uiPassCellContainer.Count; i++)
        {
            if (i < tableData.Length)
            {
                ...
                passInfo.rewardType_Free_Key = ColdSeasonPassServerTable.guimoonFree;

                passInfo.rewardType_IAP = tableData[i].Reward2;
                passInfo.rewardTypeValue_IAP = tableData[i].Reward2_Value;
                passInfo.rewardType_IAP_Key = ColdSeasonPassServerTable.guimoonAd;
    ...
    {
        splitData_Free = GetSplitData(ColdSeasonPassServerTable.guimoonFree);
        splitData_Ad = GetSplitData(ColdSeasonPassServerTable.guimoonAd);
        ...
        string free = ServerData.coldSeasonPassServerTable.TableDatas[ColdSeasonPassServerTable.guimoonFree].Value;
        string ad = ServerData.coldSeasonPassServerTable.TableDatas[ColdSeasonPassServerTable.guimoonAd].Value;
        ...
        if (rewardedNum > 0)
        {
            ServerData.coldSeasonPassServerTable.TableDatas[ColdSeasonPassServerTable.guimoonFree].Value = free;
            ServerData.coldSeasonPassServerTable.TableDatas[ColdSeasonPassServerTable.guimoonAd].Value = ad;
            ...
            passParam.Add(ColdSeasonPassServerTable.guimoonFree, ServerData.coldSeasonPassServerTable.TableDatas[ColdSeasonPassServerTable.guimoonFree].Value);
            passParam.Add(ColdSeasonPassServerTable.guimoonAd, ServerData.coldSeasonPassServerTable.TableDatas[ColdSeasonPassServerTable.guimoonAd].Value);
            ...
            ServerData.SendTransactionV2(transactions, successCallBack: () =>
            {
                ...
                //LogManager.Instance.SendLogType("GuimoonPass", "A", "A");
            });
        }
        else
        {
    ...
    {
        return PlayerStats.HasGuimoon(require);
    }
    ...
    {
        return ServerData.iapServerTable.TableDatas[UiGuimoonPassBuyButton.seasonPassKey].buyCount.Value > 0;
    }
}
