...
public class SinsunManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/Sinsun");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.sinsunScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.sinsunScore].Value = reqValue;

            ServerData.userInfoTable_2.UpDataV2(UserInfoTable_2.sinsunScore, false);
        }
