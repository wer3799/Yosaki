...
/// 
[System.Serializable]
public class SpecialRequestStarRewardTable : ScriptableObject 
{	
    ...
    public SpecialRequestStarRewardTableData[] dataArray;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new SpecialRequestStarRewardTableData[0];
