...
/// 
[System.Serializable]
public class SpecialRequestExchangeTable : ScriptableObject 
{	
    ...
    public SpecialRequestExchangeTableData[] dataArray;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new SpecialRequestExchangeTableData[0];
