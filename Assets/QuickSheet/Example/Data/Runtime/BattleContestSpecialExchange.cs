...
/// 
[System.Serializable]
public class BattleContestSpecialExchange : ScriptableObject 
{	
    ...
    public BattleContestSpecialExchangeData[] dataArray;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new BattleContestSpecialExchangeData[0];
