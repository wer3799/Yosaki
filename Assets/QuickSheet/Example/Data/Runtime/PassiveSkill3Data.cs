...
/// 
[System.Serializable]
public class PassiveSkill3Data
{
  [SerializeField]
  int id;
  ...
  [SerializeField]
  string needpassivekey;
  public string Needpassivekey { get {return needpassivekey; } set { this.needpassivekey = value;} }
  
  [SerializeField]
  int needpassivevalue;
  public int Needpassivevalue { get {return needpassivevalue; } set { this.needpassivevalue = value;} }
