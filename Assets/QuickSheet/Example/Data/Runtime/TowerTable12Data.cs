...
public class TowerTable12Data
{
  ...
  [SerializeField]
  string fruitname;
  public string Fruitname { get {return fruitname; } set { this.fruitname = value;} }
  
  [SerializeField]
  string chimname;
  public string Chimname { get {return chimname; } set { this.chimname = value;} }
