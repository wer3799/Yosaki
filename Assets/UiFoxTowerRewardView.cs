...
public class UiFoxTowerRewardView : MonoBehaviour
{
    [SerializeField]
    ...
    public void UpdateRewardView(int idx)
    {
        ...
        var towerTableData = TableManager.Instance.FoxTowerTable.dataArray[idx];
    ...
    public void OnClickRightButton()
    {
        ...
        currentId = Mathf.Min(currentId, TableManager.Instance.FoxTowerTable.dataArray.Length - 1);
    ...
    public void UpdateButtonState()
    {
        ...
        rightButton.interactable = currentId != TableManager.Instance.FoxTowerTable.dataArray.Length - 1;
    }
}
