...
public class UiFoxFirePassCell : FancyCell<FoxFirePassData_Fancy>
{
    private FoxFirePassData_Fancy itemData;
    [SerializeField]
    ...
    public void OnClickAdRewardButton()
    {
        ...
        {
            PopupManager.Instance.ShowAlarmMessage($"여우불 패스권이 필요합니다.");
        }
    }
    ...
    public override void UpdateContent(FoxFirePassData_Fancy itemData)
    {
