...
public class UiEventMission3AttendCell : FancyCell<PassData_Fancy>
{
    ...
    public void OnClickFreeRewardButton()
    {
        ...
        {
            PopupManager.Instance.ShowAlarmMessage($"교환한 {CommonString.GetItemName(Item_Type.Event_Mission3)}가 부족합니다.");
            return;
        }
    ...
    {
        int killCountTotalBok = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.commonAttend2Count).Value;
