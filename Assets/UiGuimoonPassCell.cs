...
public class UiGuimoonPassCell : MonoBehaviour
{
    [SerializeField]
    ...
    {
        descriptionText.SetText($"{Utils.ConvertBigNumForRewardCell(passInfo.require+1)}");
    }
    ...
    public void OnClickFreeRewardButton()
    {
        ...
        {
            PopupManager.Instance.ShowAlarmMessage("귀문 달성도가 부족합니다.");
            return;
        }
    ...
    {
        bool hasIapProduct = ServerData.iapServerTable.TableDatas[UiGuimoonPassBuyButton.seasonPassKey].buyCount.Value > 0;
    ...
    {
        return PlayerStats.HasGuimoon(passInfo.require);
    }
}
