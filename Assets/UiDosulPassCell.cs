...
public class UiDosulPassCell : FancyCell<DosulPassData_Fancy>
{
    private DosulPassData_Fancy itemData;
    [SerializeField]
    ...
    private void Subscribe()
    {
        ...
        //킬카운트 변경될때
        ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.dosulPassKill).AsObservable().Subscribe(e =>
        {
    ...
    public void OnClickAdRewardButton()
    {
        ...
        {
            PopupManager.Instance.ShowAlarmMessage($"도술 패스권이 필요합니다.");
        }
    }
    ...
    private void GetFreeReward()
    {
        ...
        userInfo_2Param.Add(UserInfoTable_2.dosulPassKill, ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.dosulPassKill).Value);
    ...
    private void GetAdReward()
    {
        ...
        userInfoParam.Add(UserInfoTable_2.dosulPassKill, ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.dosulPassKill).Value);
    ...
    {
        int killCountTotalColdSeason = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.dosulPassKill).Value;
    ...
    public override void UpdateContent(DosulPassData_Fancy itemData)
    {
