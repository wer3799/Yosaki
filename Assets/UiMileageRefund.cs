...
public class UiMileageRefund : MonoBehaviour
{
    ...
    private void InitializeEvent()
    {
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 1)
        {
                    
            ServerData.userInfoTable.GetTableData(initKey).Value = 1;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 2)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 2;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 3)
        {          
            ServerData.userInfoTable.GetTableData(initKey).Value = 3;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 4)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 4;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 5)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 5;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 6)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 6;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 7)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 7;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 8)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 8;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 9)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 9;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 17)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 17;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 21)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 21;
            //할로윈 상점 교환횟수 초기화
            ServerData.userInfoTable.GetTableData(UserInfoTable.eventMission0_0).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.eventMission0_1).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.eventMission0_2).Value = 0;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 22)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 22;
            //엘릭서재화 1로
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 24)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 24;
            ServerData.userInfoTable.GetTableData(UserInfoTable.eventMission1_0).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.eventMission1_1).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.eventMission1_2).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.eventMission1_3).Value = 0;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 30)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 30;
            ServerData.userInfoTable.GetTableData(UserInfoTable.killCountTotalWinterPass).Value = 0;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 35)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 35;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_0).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_1).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_2).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_3).Value = 0;
        ...
        //12월 21일 업데이트
         if (ServerData.userInfoTable.GetTableData(initKey).Value < 42)
         {           
             ServerData.userInfoTable.GetTableData(initKey).Value = 42;
        ...
        //1월4일 업데이트
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 44)
        {           
             ServerData.userInfoTable.GetTableData(initKey).Value = 44;
        ...
        //1/17  업데이트
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 51)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 51;
        ...
        //1/17  업데이트
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 53)
        {
            ServerData.userInfoTable.GetTableData(initKey).Value = 53;
        ...
        //2/2 핫픽스
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 54)
        {
            List<TransactionValue> transactions = new List<TransactionValue>();
            
            Param userInfoParam = new Param();
            ServerData.userInfoTable.GetTableData(initKey).Value = 54;
            userInfoParam.Add(initKey, ServerData.userInfoTable.GetTableData(initKey).Value);
            transactions.Add(TransactionValue.SetUpdate(UserInfoTable.tableName, UserInfoTable.Indate, userInfoParam));
        ...
        //2/16
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 55)
        {
            List<TransactionValue> transactions = new List<TransactionValue>();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 55;
            ServerData.userInfoTable.GetTableData(UserInfoTable.killCountTotalWinterPass).Value = 0;
        ...
        //2/27
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 59)
        {
            List<TransactionValue> transactions = new List<TransactionValue>();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 59;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_0).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_1).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_2).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_3).Value = 0;
        ...
        //3/14  업데이트
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 61)
        {
            Param userInfoParam = new Param();
            Param goodsParam = new Param();
            Param etcParam = new Param();
            
            ServerData.userInfoTable.GetTableData(initKey).Value = 62;
        ...
        if ((int)ServerData.userInfoTable.GetTableData(initKey).Value == 61)
        {
            Param userInfoParam = new Param();
            Param goodsParam = new Param();
        ...
        //2/16
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 63)
        {
            List<TransactionValue> transactions = new List<TransactionValue>();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 63;
            ServerData.userInfoTable.GetTableData(UserInfoTable.killCountTotalWinterPass).Value = 0;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 64)
        {
            List<TransactionValue> transactions = new List<TransactionValue>();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 64;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 69)
        {
            List<TransactionValue> transactions = new List<TransactionValue>();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 69;
            userInfoParam.Add(initKey, ServerData.userInfoTable.GetTableData(initKey).Value);
         ...
         if (ServerData.userInfoTable.GetTableData(initKey).Value < 70)
        {
            List<TransactionValue> transactions = new List<TransactionValue>();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 70;
            var beforeStar = ServerData.specialRequestBossServerTable.GetTotalStar();
            var beforeReward = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.specialRequestTotalRewardIdx).Value;
            ...
            ServerData.SendTransactionV2(transactions, successCallBack: () =>
            {
               ...
               //3/14  업데이트
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 72)
        {
            Param userInfoParam = new Param();
            Param userInfo2Param = new Param();
            Param goodsParam = new Param();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 72;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 75)
        {
            Param userInfoParam = new Param();
            Param userInfo2Param = new Param();
            Param goodsParam = new Param();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 75;
            //빙고 초기화
            ServerData.etcServerTable.TableDatas[EtcServerTable.gachaEventReward].Value = string.Empty;
            //이벤트상품 초기화
            ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.eventPackageRewardIdx).Value = -1;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 77)
        {
            Param userInfoParam = new Param();
            Param goodsParam = new Param();
            Param passParam = new Param();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 77;
        ...
        //5/28
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 81)
        {
            List<TransactionValue> transactions = new List<TransactionValue>();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 81;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_0).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_1).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_2).Value = 0;
            ServerData.userInfoTable.GetTableData(UserInfoTable.snow_exchangeCount_3).Value = 0;
        ...
        //5/28
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 83)
        {
            List<TransactionValue> transactions = new List<TransactionValue>();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 83;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 85)
        {
            Param userInfoParam = new Param();
            Param userInfo2Param = new Param();
         //   Param goodsParam = new Param();
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 85;
        ...
        if (ServerData.userInfoTable.GetTableData(initKey).Value < 88)
        {
            ...
            ServerData.userInfoTable.GetTableData(initKey).Value = 88;
            userInfoParam.Add(initKey, ServerData.userInfoTable.GetTableData(initKey).Value);
