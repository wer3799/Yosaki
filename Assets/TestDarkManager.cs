...
public class TestDarkManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/TestDark");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.darkGodScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.darkGodScore].Value = reqValue;

            ServerData.userInfoTable_2.UpDataV2(UserInfoTable_2.darkGodScore, false);
        }
