...
public class GyungRockTowerManager5 : ContentsManagerBase
{
    [SerializeField]
    ...
    {
        int stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower5).Value;

        var SumisanTowerTableData = TableManager.Instance.gyungRockTowerTable5.dataArray[stageId];
    ...
    {
        stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower5).Value;

        var tableData = TableManager.Instance.gyungRockTowerTable5.dataArray[stageId];
    ...
    private void SetClear()
    {
        ...
        //�ܰ���
        ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower5).Value++;

        Param floorParam = new Param();

        floorParam.Add(UserInfoTable_2.gyungRockTower5, ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower5).Value);
