...
using BackEnd;
public class ByeolhoTowerManager : ContentsManagerBase
{
   [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/ByeolhoTower");
    ...
    {
        var rewardedIdx = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.byeolhoTowerRewardIndex).Value;

        int currentGradeId = PlayerStats.GetByeolhoTowerGrade();
        //플레이 X
        if (currentGradeId < 0)
        {
        ...
        int rewarededindex = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.byeolhoTowerRewardIndex).Value;
        ...
        ServerData.goodsTable.TableDatas[GoodsTable.ByeolhoGoods].Value += sumValue;

        ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.byeolhoTowerRewardIndex).Value = currentGradeId;
        ...
        userInfo2Param.Add(UserInfoTable_2.byeolhoTowerRewardIndex, ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.byeolhoTowerRewardIndex].Value);
    ...
    private void SendScore()
    {
        ...
        if (reqValue >ServerData.bossScoreTable.TableDatas_Double[BossScoreTable.byeolhoTowerScore].Value)
        {
            ServerData.bossScoreTable.UpdateScoreToServer(BossScoreTable.byeolhoTowerScore,reqValue);
        }
    }
