...
public class UiChunSangTowerBoard : MonoBehaviour
{
     [SerializeField]
    ...
    private bool IsAllClear()
    {
        ...
        return currentFloor >= TableManager.Instance.SkyTowerTable.dataArray.Length;
    }
    ...
    private void SetReward()
    {
        ...
        if (isAllClear == false)
        {
            ...
            if (currentFloor >= TableManager.Instance.SkyTowerTable.dataArray.Length)
            {
                PopupManager.Instance.ShowConfirmPopup(CommonString.Notice, $"잘못된 데이터 idx : {currentFloor}", null);
                return;
            }

            var towerTableData = TableManager.Instance.SkyTowerTable.dataArray[currentFloor];
        ...
        else
        {
            ...
            var towerTableData = TableManager.Instance.SkyTowerTable.dataArray.Last();
    ...
    public void OnClickEnterButton()
    {
        PopupManager.Instance.ShowYesNoPopup(CommonString.Notice, "입장 할까요?", () =>
        {
            ...
            GameManager.Instance.LoadContents(GameManager.ContentsType.ChunSangTower);
