...
public class GyungRockTowerManager4 : ContentsManagerBase
{
    [SerializeField]
    ...
    {
        int stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower4).Value;

        var SumisanTowerTableData = TableManager.Instance.gyungRockTowerTable4.dataArray[stageId];
    ...
    {
        stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower4).Value;

        var tableData = TableManager.Instance.gyungRockTowerTable4.dataArray[stageId];
    ...
    private void SetClear()
    {
        ...
        //�ܰ���
        ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower4).Value++;

        Param floorParam = new Param();

        floorParam.Add(UserInfoTable_2.gyungRockTower4, ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower4).Value);
