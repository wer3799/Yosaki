...
public class UiEventMission2AttendCell : FancyCell<PassData_Fancy>
{
    ...
    {
        int killCountTotalBok = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.eventMission2AttendCount).Value;
    ...
    public void OnClickFreeRewardButton()
    {
        ...
        {
            PopupManager.Instance.ShowAlarmMessage($"출석일 수가 부족합니다.");
            return;
        }
    ...
    {
        bool hasIapProduct = ServerData.iapServerTable.TableDatas[UiChuseokPassBuyButton.seasonPassKey].buyCount.Value > 0;
    ...
    private void GetFreeReward()
    {
        ...
        var rewardTransactionValue = ServerData.GetItemTypeTransactionValueForAttendance((Item_Type)(int)passInfo.rewardType_Free,passInfo.rewardTypeValue_Free);
    ...
    private void GetAdReward()
    {
        ...
        var rewardTransactionValue = ServerData.GetItemTypeTransactionValueForAttendance((Item_Type)(int)passInfo.rewardType_IAP,passInfo.rewardTypeValue_IAP);
