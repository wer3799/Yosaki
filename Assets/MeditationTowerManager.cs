...
using BackEnd;
public class MeditationTowerManager : ContentsManagerBase
{
   [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/MeditationTower");
    ...
    {
        var rewardedIdx = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.meditationTowerRewardIndex).Value;

        int currentGradeId = PlayerStats.GetMeditationTowerGrade();
        //플레이 X
        if (currentGradeId < 0)
        {
        ...
        int rewarededindex = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.meditationTowerRewardIndex).Value;
        ...
        ServerData.goodsTable.TableDatas[GoodsTable.MeditationGoods].Value += sumValue;

        ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.meditationTowerRewardIndex).Value = currentGradeId;
        ...
        userInfo2Param.Add(UserInfoTable_2.meditationTowerRewardIndex, ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.meditationTowerRewardIndex].Value);
