...
public class UiDragonTowerRewardView : MonoBehaviour
{
    [SerializeField]
    ...
    public void UpdateRewardView(int idx)
    {
        ...
        var towerTableData = TableManager.Instance.DragonTowerTable.dataArray[idx];
    ...
    public void OnClickRightButton()
    {
        ...
        currentId = Mathf.Min(currentId, TableManager.Instance.DragonTowerTable.dataArray.Length - 1);
    ...
    public void UpdateButtonState()
    {
        ...
        rightButton.interactable = currentId != TableManager.Instance.DragonTowerTable.dataArray.Length - 1;
    }
}
