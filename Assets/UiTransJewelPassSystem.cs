...
public class UiTransJewelPassSystem : MonoBehaviour
{
    [SerializeField]
    private UiTransJewelPassCell uiPassCellPrefab;
    ...
    private List<UiTransJewelPassCell> uiPassCellContainer = new List<UiTransJewelPassCell>();
    ...
    private void Subscribe()
    {
        ...
        void SetText()
        {
            var level = (int)ServerData.etcServerTable.GetTransJewelLevel(3);
    ...
    {
        var tableData = TableManager.Instance.TransJewelPass.dataArray;
        for (int i = 0; i < tableData.Length; i++)
        {
            var prefab = Instantiate<UiTransJewelPassCell>(uiPassCellPrefab, cellParent);
        ...
        for (int i = 0; i < uiPassCellContainer.Count; i++)
        {
            if (i < tableData.Length)
            {
                ...
                passInfo.rewardType_Free_Key = ColdSeasonPassServerTable.transJewelFree;

                passInfo.rewardType_IAP = tableData[i].Reward2;
                passInfo.rewardTypeValue_IAP = tableData[i].Reward2_Value;
                passInfo.rewardType_IAP_Key = ColdSeasonPassServerTable.transJewelAd;
    ...
    public void OnClickAllReceiveButton()
    {
        ...
        string freeKey = ColdSeasonPassServerTable.transJewelFree;
        string adKey = ColdSeasonPassServerTable.transJewelAd;
    ...
    {
        return ServerData.etcServerTable.GetTransJewelLevel(3) >= require;
    }
    ...
    {
        return ServerData.iapServerTable.TableDatas[PassBuyButton.transJewelPassKey].buyCount.Value > 0;
    }
}
