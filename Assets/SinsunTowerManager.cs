...
public class SinsunTowerManager : ContentsManagerBase
{
    ...
    private IEnumerator StartAutoStart()
    {
        ...
        {
            GameManager.Instance.LoadContents((ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.SansinTowerIdx).Value >=
                                               TableManager.Instance.sinsunTowerTable.dataArray.Length) == false
