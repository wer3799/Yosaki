...
public class DragonTowerManager : ContentsManagerBase
{
    [SerializeField]
    ...
    {
        int stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.DragonTowerIdx).Value;

        var TowerTableData2 = TableManager.Instance.DragonTowerTable.dataArray[stageId];
        EnemyTableData spawnEnemyData = GetSpawnedEnemy(stageId);

        for (int i = 0; i < TowerTableData2.Spawnnum; i++)
        {
            poolName = $"Enemy/DragonTower/{spawnEnemyData.Prefabname}";
    ...
    {
        stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.DragonTowerIdx).Value;

        var tableData = TableManager.Instance.DragonTowerTable.dataArray[stageId];
    ...
    private void SetClear()
    {
        ...
        var TowerTableData3 = TableManager.Instance.DragonTowerTable.dataArray[currentFloor];
        ...
        //단계상승
        ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.DragonTowerIdx).Value++;

        Param floorParam = new Param();

        floorParam.Add(UserInfoTable_2.DragonTowerIdx, ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.DragonTowerIdx).Value);
