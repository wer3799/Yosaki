...
public class TestThiefManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/TestThief");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.thiefGodScore].Value)
        {
            ServerData.userInfoTable_2.TableDatas[UserInfoTable_2.thiefGodScore].Value = reqValue;

            ServerData.userInfoTable_2.UpData(UserInfoTable_2.thiefGodScore, false);
        }
