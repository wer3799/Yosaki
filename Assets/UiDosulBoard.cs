...
public class UiDosulBoard : MonoBehaviour
{
    ...
    {
        scoreText.SetText($"최고 점수 : {Utils.ConvertBigNum(ServerData.bossScoreTable.TableDatas_Double[BossScoreTable.dosulScore].Value * GameBalance.BossScoreConvertToOrigin)}");
