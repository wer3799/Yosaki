...
public class UiEventMission1Cell : MonoBehaviour
{
    [SerializeField]
    ...
    public void Initialize(EventMissionData tableData)
    {
        ...
        if (tableData.EVENTMISSIONTYPE == EventMissionType.THIRD)
        {
    ...
    {
        return ServerData.iapServerTable.TableDatas[UiEventPassBuyButton.productKey].buyCount.Value > 0;
    }
    ...
    public void OnClickGetButton()
    {
        ...
        {
            ServerData.goodsTable.AddLocalData(ServerData.goodsTable.ItemTypeToServerString(Item_Type.Event_Mission1_All), rewardGemNum);
        }
    ...
    private IEnumerator SyncDataRoutine()
    {
        ...
        {
            goodsParam.Add(ServerData.goodsTable.ItemTypeToServerString(Item_Type.Event_Mission1_All), ServerData.goodsTable.GetTableData(ServerData.goodsTable.ItemTypeToServerString(Item_Type.Event_Mission1_All)).Value);
        }
