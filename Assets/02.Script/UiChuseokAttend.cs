...
public class UiChuseokAttend : MonoBehaviour
{
    [SerializeField] private ChuseokAttendCell cell;
    ...
    private void Initialize()
    {
        ...
        {
            var prefab = Instantiate<ChuseokAttendCell>(cell, cellParentTransform);
