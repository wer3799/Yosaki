...
public class UiEventMission2AttendPass : FancyScrollView<PassData_Fancy>
{
    ...
    public void OnClickAllReceiveButton()
    {
     var tableData = TableManager.Instance.CommonEventAttend2.dataArray;
        ...
        var adKey = OneYearPassServerTable.event2AttendAd;
        ...
        string free = ServerData.oneYearPassServerTable.TableDatas[freeKey].Value;
    ...
    {
        var currentValue = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.eventMission2AttendCount).Value;
        return currentValue >= require;
    }
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < tableData.Length; i++)
        {
            ...
            passInfo.rewardType_Free_Key = OneYearPassServerTable.event2AttendFree;

            passInfo.rewardType_IAP = tableData[i].Reward2;
            passInfo.rewardTypeValue_IAP = tableData[i].Reward2_Value;
            passInfo.rewardType_IAP_Key = OneYearPassServerTable.event2AttendAd;
