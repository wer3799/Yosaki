...
public class UiChuseokMission : MonoBehaviour
{
    [SerializeField]
    private UiChuseokMissionCell missionCell;
    [SerializeField]
    ...
    private Dictionary<int, UiChuseokMissionCell> cellContainer = new Dictionary<int, UiChuseokMissionCell>();
    ...
    private void Initialize()
    {
        ...
        for (int i = 0; i < tableData.Length; i++)
        {
            ...
            var cell = Instantiate<UiChuseokMissionCell>(missionCell, cellParent);
        ...
        for (int i = 0; i < tableData.Length; i++)
        {
            ...
            var cell = Instantiate<UiChuseokMissionCell>(missionCell, seasonCellParent);
