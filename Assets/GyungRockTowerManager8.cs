...
public class GyungRockTowerManager8 : ContentsManagerBase
{
    [SerializeField]
    ...
    {
        //int currentScore = (int)DatabaseManager.userInfoTable.GetTableData(UserInfoTable.currentFloorIdx8).Value;
    ...
    {
        int stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower8).Value;

        var towerTableData = TableManager.Instance.gyungRockTowerTable8.dataArray[stageId];
    ...
    {
        stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower8).Value;

        var tableData = TableManager.Instance.gyungRockTowerTable8.dataArray[stageId];
    ...
    private void SetClear()
    {
        ...
        ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower8).Value++;

        Param floorParam = new Param();

        floorParam.Add(UserInfoTable_2.gyungRockTower8, ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower8).Value);
