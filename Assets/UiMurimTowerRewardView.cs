...
public class UiMurimTowerRewardView : MonoBehaviour
{
    [SerializeField]
    ...
    public void UpdateRewardView(int idx)
    {
        ...
        var towerTableData = TableManager.Instance.MurimTowerTable.dataArray[idx];
    ...
    public void OnClickRightButton()
    {
        ...
        currentId = Mathf.Min(currentId, TableManager.Instance.MurimTowerTable.dataArray.Length - 1);
    ...
    public void UpdateButtonState()
    {
        ...
        rightButton.interactable = currentId != TableManager.Instance.MurimTowerTable.dataArray.Length - 1;
    }
}
