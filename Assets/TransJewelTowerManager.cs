...
using BackEnd;
public class TransJewelTowerManager : ContentsManagerBase
{
   [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/TransJewelTower");
    ...
    private void SendScore()
    {
        ...
        {
            ServerData.bossScoreTable.UpdateScoreToServer(BossScoreTable.transJewelScore,reqValue);
        }
    }
    ...
    private void ShowResultPopup()
    {
        ...
        uiBossResultPopup.Initialize(Utils.ConvertNum(damageAmount.Value));
    }
