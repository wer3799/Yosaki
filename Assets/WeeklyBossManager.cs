...
public class WeeklyBossManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/WeeklyBoss");
    ...
    private void SendScore()
    {
        ...
        if (reqValue >ServerData.bossScoreTable.TableDatas_Double[BossScoreTable.weeklyBossScore].Value)
        {
            ServerData.bossScoreTable.UpdateScoreToServer(BossScoreTable.weeklyBossScore,reqValue);
