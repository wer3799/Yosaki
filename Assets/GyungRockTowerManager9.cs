...
public class GyungRockTowerManager9 : ContentsManagerBase
{
    [SerializeField]
    ...
    {
        int stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower9).Value;

        var towerTableData = TableManager.Instance.gyungRockTowerTable9.dataArray[stageId];
    ...
    {
        stageId = (int)ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower9).Value;

        var tableData = TableManager.Instance.gyungRockTowerTable9.dataArray[stageId];
    ...
    private void SetClear()
    {
        ...
        ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower9).Value++;

        Param floorParam = new Param();

        floorParam.Add(UserInfoTable_2.gyungRockTower9, ServerData.userInfoTable_2.GetTableData(UserInfoTable_2.gyungRockTower9).Value);
